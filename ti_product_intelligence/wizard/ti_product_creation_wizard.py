...
from odoo.addons.ti_product_intelligence.models.product_governance import normalize_text
...
class TiProductCreationWizard(models.TransientModel):
    ...
    def _spec_value_map(self):
        ...
        for line in self.spec_line_ids:
            values[line.attribute_id.id] = line.display_value
            values[line.attribute_id.code] = line.display_value
        return values
    ...
    def action_check_duplicates(self):
        ...
        threshold = self.category_id.review_threshold or 60.0
    ...
    def action_create_product(self):
        ...
        for duplicate in self.duplicate_line_ids:
            state = "approved" if self.override_duplicate else ("blocked" if duplicate.score >= self.category_id.duplicate_threshold else "review")
